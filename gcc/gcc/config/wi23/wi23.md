...
(define_code_iterator FOP [plus minus mult])
(define_code_attr fop [(plus "add") (minus "sub") (mult "mul")])
...
(define_insn "*movsi"
  [(set (match_operand:SI 0 "nonimmediate_operand"         "=r,r ,BW,r ,A,r,r,r,r")
        (match_operand:SI 1 "wi23_general_movsrc_operand"   "r,rO,r ,BW,r,A,s,i,e"))]
...
(define_insn "*mov_addrhi"
  [(set (match_operand:SI 0 "register_operand" "=r")
        (match_operand:SI 1 "general_operand" ""))]
  ""
  "lbi %0,$h:%1")

(define_insn "*mov_addrlo"
  [(set (match_operand:SI 0 "register_operand" "=r")
        (match_operand:SI 1 "general_operand" ""))]
  ""
  "slbi %0,%1")
...
(define_insn "*call_value"
  [(set (match_operand 0 "register_operand" "=r,f")
	(call (mem:SI (match_operand:SI
		       1 "immediate_operand" "i,i"))
	      (match_operand 2 "" "")))]
  ""
  "@
  jal %1
