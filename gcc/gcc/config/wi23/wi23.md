...
(define_insn "*movqi"
  [(set (match_operand:QI 0 "nonimmediate_operand"         "=r,r ,BW,r ,r,r")
        (match_operand:QI 1 "wi23_general_movsrc_operand"   "r,rO,r ,BW,i,e"))]
...
;; same for half-word
(define_insn "*movhi"
  [(set (match_operand:HI 0 "nonimmediate_operand"         "=r,r ,BW,r ,r,r")
        (match_operand:HI 1 "wi23_general_movsrc_operand"   "r,rO,r ,BW,i,e"))]
